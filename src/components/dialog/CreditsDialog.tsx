        ...
        <div css={theme => ([{
          ...
          <div css={theme => ([{
            ...
            <a href={"https://zentrum-digitalisierung.bayern/"} target={"_blank"}>
              <img alt={"Zentrum Digitalisierung.Bayern"} width={"100%"} src={require( '../../assets/img/Zentrum-Digitalisierung.Bayern.jpg' )}/>
            </a>
          </div>
          ...
          <div css={theme => ([{
            ...
            <div css={theme => ([{
              ...
              <a style={{width:"50%"}} href={"https://www.concern.de/"} target={"_blank"}>
                <img alt={"concern"} width={'70%'} src={require( '../../assets/img/concern.png' )}/>
              </a>
              <a style={{width:"50%"}} href={"https://www.ingenit.com/"} target={"_blank"}>
                <img alt={"ingenit"} width={'70%'} src={require( '../../assets/img/ingenit.png' )}/>
              </a>
            </div>
            ...
            <a css={theme => ([{}])} href={"https://www.stmuv.bayern.de/"} target={"_blank"}>
              <img alt={"Bayrisches Staatsministerium für Umwelt und Verbraucherschutz"} width={'100%'} src={require( '../../assets/img/StMUV.jpg' )}/>
            </a>
          ...
          <div css={theme => ([{
            ...
            <a href={"https://github.com/ingenitdo/dpm"} target={"_blank"}>
              <img alt={"github DPM repository"} width={'100%'} src={require( '../../assets/img/github.png' )}/>
            </a>
