...
export const renderIconGroup = ( x: number, y: number, width: number, height: number, color: string,
  textColor: string ) => {
  const scaleWidth = width / 56;
  const scaleHeight = height / 69;
  return (
    <svg viewBox={"0 0 " + width + " " + height} height={height} width={width} x={x} y={y} fill={color}>
      <g transform={'scale( ' + scaleWidth + ' ' + scaleHeight + ')'}>


        <g id="group_1_" data-name="group (1)" transform="translate(0.002 0.002)">
          <path id="Path_147" data-name="Path 147"
                d="M13.928,21.045A8.1,8.1,0,0,0,7.7,24.051H4.557A5.384,5.384,0,0,1,1.315,23.1,3.219,3.219,0,0,1,0,20.317q0-8.291,2.912-8.291a4.482,4.482,0,0,1,1.022.493,15.447,15.447,0,0,0,2.29,1,8.244,8.244,0,0,0,2.8.5,9.436,9.436,0,0,0,3.124-.54,11.709,11.709,0,0,0-.117,1.55A10.342,10.342,0,0,0,13.928,21.045ZM39.083,36.006a5.853,5.853,0,0,1-1.715,4.451,6.334,6.334,0,0,1-4.557,1.632H12.284a6.334,6.334,0,0,1-4.557-1.632,5.853,5.853,0,0,1-1.715-4.451q0-1.245.082-2.431a23.921,23.921,0,0,1,.329-2.56,19.908,19.908,0,0,1,.622-2.548,12.074,12.074,0,0,1,1.01-2.29,8.258,8.258,0,0,1,1.456-1.9,6.127,6.127,0,0,1,2.008-1.257,7.053,7.053,0,0,1,2.619-.47,2.768,2.768,0,0,1,1.01.5q.775.5,1.715,1.127a10.3,10.3,0,0,0,2.513,1.127,10.207,10.207,0,0,0,6.342,0,10.3,10.3,0,0,0,2.513-1.127q.94-.622,1.715-1.127a2.768,2.768,0,0,1,1.01-.5,7.053,7.053,0,0,1,2.619.47,6.127,6.127,0,0,1,2.008,1.257,8.258,8.258,0,0,1,1.456,1.9,12.074,12.074,0,0,1,1.01,2.29,19.909,19.909,0,0,1,.622,2.548A23.923,23.923,0,0,1,39,33.575Q39.083,34.762,39.083,36.006ZM15.032,6.013a5.793,5.793,0,0,1-1.762,4.251,5.793,5.793,0,0,1-4.251,1.762,5.793,5.793,0,0,1-4.251-1.762A5.793,5.793,0,0,1,3.006,6.013,5.793,5.793,0,0,1,4.768,1.762,5.793,5.793,0,0,1,9.019,0,5.793,5.793,0,0,1,13.27,1.762,5.793,5.793,0,0,1,15.032,6.013Zm16.535,9.019a8.69,8.69,0,0,1-2.642,6.377,8.69,8.69,0,0,1-6.377,2.642,8.69,8.69,0,0,1-6.377-2.642,8.69,8.69,0,0,1-2.642-6.377,8.69,8.69,0,0,1,2.642-6.377,8.69,8.69,0,0,1,6.377-2.642,8.69,8.69,0,0,1,6.377,2.642A8.69,8.69,0,0,1,31.567,15.032ZM45.1,20.317A3.218,3.218,0,0,1,43.781,23.1a5.384,5.384,0,0,1-3.241.951H37.392a8.1,8.1,0,0,0-6.224-3.006,10.342,10.342,0,0,0,1.9-6.013,11.708,11.708,0,0,0-.117-1.55,9.436,9.436,0,0,0,3.124.54,8.244,8.244,0,0,0,2.8-.5,15.447,15.447,0,0,0,2.29-1,4.482,4.482,0,0,1,1.022-.493Q45.1,12.026,45.1,20.317ZM42.09,6.013a5.793,5.793,0,0,1-1.762,4.251,6.011,6.011,0,0,1-8.5,0,5.793,5.793,0,0,1-1.762-4.251,5.793,5.793,0,0,1,1.762-4.251,6.011,6.011,0,0,1,8.5,0A5.793,5.793,0,0,1,42.09,6.013Z"
                transform="translate(-0.002 -0.002)"/>
        </g>
        <path id="Path_144" data-name="Path 144"
              d="M5,0H21a5,5,0,0,1,5,5V36a5,5,0,0,1-5,5H5a5,5,0,0,1-5-5V5A5,5,0,0,1,5,0Z"
              transform="translate(27.02 27.035)" fill={textColor}/>
        <g id="Group_2928" data-name="Group 2928" transform="translate(-606.98 -90.965)">
          ...
          <g id="Ellipse_6" data-name="Ellipse 6" transform="translate(646 150)" fill="#fff" stroke={color}
             strokeWidth="3">
            <circle cx="2.5" cy="2.5" r="2.5" stroke="none"/>
            <circle cx="2.5" cy="2.5" r="1" fill="none"/>
          </g>
          <g id="Ellipse_7" data-name="Ellipse 7" transform="translate(641 119)" fill="#fff" stroke={color}
             strokeWidth="3">
...
export const renderInfoButton = ( x: number, y: number, size: number, color: string, textColor: string | undefined,
  ...
  return (
    <svg x={x - size} y={y} height={size} width={size} fill={color} onClick={onClick}>
      <title>{title}</title>
      <circle cx={size / 2} cy={size / 2} r={size / 2}/>
      <text x={size / 2}
            y={size * 0.8 / 2 + size * 0.8 / 4 + (isLowMode ? 3 : 0)}
...
export const renderIconClockAndDatabase = ( x: number, y: number, size: number, color: string, textColor: string,
  ...
  return (
    <svg viewBox={"0 0 " + size + " " + size} height={size} width={size} x={x} y={y} fill={color} onClick={onClick}>
      <title>{title}</title>
      <circle cx={size / 2} cy={size / 2} r={size / 1.5} fill={textColor}/>
      <g transform={'scale( ' + scaleWidth + ' ' + scaleHeight + ')'}>
